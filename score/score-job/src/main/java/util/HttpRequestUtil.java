...
//		        stringEntity.setContentEncoding("UTF-8");
		    	...
		    	log.error("IOException from " + reqURL + " with " + json , e);
//		        throw new MemberException("HTTP CLIENT EXCEPTION : CLASS:HttpClientUtil" , e);
		    } finally {
//		    	httpClient.getConnectionManager().shutdown();
     ...
     */
    public  String sendGet(String url, String param,String cookies,Boolean isSSL) {
        String result = "";
     ...
     * @return 所代表远程资源的响应结果
     */
    public  String sendPost(String url, String param,String cookies) {
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  System.out.println(paramData);
       ...
       // m.sendPost("http://10.202.185.165:8080/FeiniuScore/growth/mem/queryLevelCount", paramData,"");
        ...
        String getGrowthDetailList=hr.sendPost("http://10.202.185.165:8080/FeiniuScore/growth/mem/queryLevel",HttpRequestUtil.assemblyJsonParam(params),"");
