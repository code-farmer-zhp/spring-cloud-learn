...
<div class="mc-main m-fixed">
	...
	<div class="mc-menu">
		<ul>
			...
			<li><a class="selected" href="${basePath}subscribe/memberList"
				title="会员关怀"> <i class="care"></i> <span>会员关怀</span>
					<b>礼包、成长值</b>
			</a></li>
...
<script>
	...
	require([static_domain + "/product/js/controller/member/config.js?version="+ time_stamp ], function() {
				...
				require([ "lib/jquery/1.11.1/jquery-1.11.1.min", 'controller/member/memberList',  "controller/shop/cart"], function() {
					
					require([ static_domain + '/product/js/lib/upLogger.js', static_domain + '/product/js/lib/idigger.js' ], function() {
							//埋点
							upLogger.acceptLinkParams('1', '7041', '7', '','2');
