...
public class CookieUtil {
    ...
    public static String getCookieValue(HttpServletRequest request, String name){
        ...
        if(ck!=null){
            try {
                return StringUtils.isBlank(ck.getValue()) ? null : URLDecoder.decode(ck.getValue(),"UTF-8");
    ...
    public static void setCookie(HttpServletResponse response, String name, String value, String domain, String path, boolean secure) {
        Cookie cookie = new Cookie(name ,value);
        cookie.setDomain(domain);
        cookie.setPath(path);
        cookie.setSecure(secure);
