...
<div class="mc-main m-fixed">
	...
	<div class="mc-menu">
		<ul>
			...
			<li><a class="selected" href="${basePath}subscribe/activityList"
				title="活动通知"> <i class="acts"></i> <span>活动通知</span>
					<b>优惠、促销</b>
			</a></li>
...
<script>
	...
	require([static_domain + "/product/js/controller/member/config.js?version=" + time_stamp ], function() {
				...
				require([ "lib/jquery/1.11.1/jquery-1.11.1.min", 'controller/member/activityList', "controller/shop/cart"], function() {
			
					require([ static_domain + '/product/js/lib/upLogger.js', static_domain + '/product/js/lib/idigger.js' ], function() {
							//埋点
							upLogger.acceptLinkParams('1', '7041', '7', '','3');
